...
static ULONG setup_mix(ULONG temp)
{
...
static ULONG setup_mix2(ULONG temp)
{
...
static INT _rijndael_ecb_encrypt(const UCHAR *pt, UCHAR *ct, symmetric_key *skey) 
#else
INT ECB_ENC(const UCHAR *pt, UCHAR *ct, symmetric_key *skey)
#endif
{
    ULONG s0, s1, s2, s3, t0, t1, t2, t3, *rk;
    INT Nr, r;
...
*/
#ifdef LTC_CLEAN_STACK
static INT _rijndael_ecb_decrypt(const UCHAR *ct, UCHAR *pt, symmetric_key *skey) 
#else
INT ECB_DEC(const UCHAR *ct, UCHAR *pt, symmetric_key *skey)
#endif
{
    ULONG s0, s1, s2, s3, t0, t1, t2, t3, *rk;
    INT Nr, r;
