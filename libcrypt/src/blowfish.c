 ...
 */
INT blowfish_setup(const UCHAR *key, INT keylen, INT num_rounds,
                   symmetric_key *skey)
{
   ULONG x, y, z, A;
   UCHAR B[8];
...
*/
#ifdef LTC_CLEAN_STACK
static INT _blowfish_ecb_encrypt(const UCHAR *pt, UCHAR *ct, symmetric_key *skey)
#else
...
*/
#ifdef LTC_CLEAN_STACK
static INT _blowfish_ecb_decrypt(const UCHAR *ct, UCHAR *pt, symmetric_key *skey)
#else
