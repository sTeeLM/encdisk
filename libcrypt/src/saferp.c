...
static void _round(UCHAR *b, INT i, symmetric_key *skey) 
{
   ROUND(b, i);
}

static void _iround(UCHAR *b, INT i, symmetric_key *skey)
{
   iROUND(b, i);
}

static void _lt(UCHAR *b, UCHAR *b2)
{
   LT(b, b2);
}

static void _ilt(UCHAR *b, UCHAR *b2)
{
   iLT(b, b2);
}   
