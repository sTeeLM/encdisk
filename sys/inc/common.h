...
/// Specifies that image files are created with encrypt attribute.
#define IMSCSI_OPTION_ENCRYPT           0x00000008

/// Check if flags specifies encrypt
#define IMSCSI_ENCRYPT(x)           ((ULONG)(x) & 0x00000008)
...
#define IMSCSI_AUTO_DEVICE_NUMBER        IMSCSI_ALL_DEVICES
